...
const Notification = () => {
    ...
    return (
        <div>
            {seeAll ? (
                <ContainerNotification handleShowLess={handleShowLess} />
            ) : (
                <div>
                    <div className="flex justify-between items-center">
                        ...
                        <p className='text-[#0095FF] underline poppins font-semibold text-lg cursor-pointer' onClick={handleChangeTab}>View all</p>
                    </div>
