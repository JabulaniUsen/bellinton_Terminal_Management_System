      ...
      <form action="" onSubmit={handleSubmit} >
        <div className=''>
            ...
            <div className="grid grid-cols-2">
                ...
                <div className="flex flex-col gap-2 my-2">
                <label htmlFor="name" className='text-base font-semibold'>Invoice Date:</label>
                ...
                <div className="flex flex-col gap-2 my-2">
                <label htmlFor="name" className='text-base font-semibold'>Total Amount Due:</label>
                <input required type="text" className='rounded-lg p-2 border border-gray-500 outline-none w-[400px]' id="contactPerson" name="contactPerson" placeholder='Enter total amount due' />
                </div>
            ...
            <div className="grid grid-cols-2">
                <div className="flex flex-col gap-2 my-2">
                <label htmlFor="name" className='text-base font-semibold'>Export Handling Fees:</label>
                ...
                <div className="flex flex-col gap-2 my-2">
                <label htmlFor="name" className='text-base font-semibold'>Storage Charge:</label>
                ...
                <div className="flex flex-col gap-2 my-2">
                <label htmlFor="name" className='text-base font-semibold'>Haulage (Truck):</label>
                <input required type="text" className='rounded-lg p-2 border border-gray-500 outline-none w-[400px]' id="Haulage" name="Haulage" placeholder='Enter Haulage:' />
                </div>


                <div className="flex flex-col gap-2 my-2">
                <label htmlFor="name" className='text-base font-semibold'>Discounts or Adjustments:</label>
                <input required type="text" className='rounded-lg p-2 border border-gray-500 outline-none w-[400px]' id="Discounts or Adjustments" name="Discounts or Adjustments" placeholder='Enter Discounts or Adjustments:' />
                </div>
                <div className="flex flex-col gap-2 my-2">
                <label htmlFor="name" className='text-base font-semibold'>Rated upto Date:</label>
                <input required type="date" className='rounded-lg p-2 border border-gray-500 outline-none w-[400px]' id="Rated upto Date" name="Rated upto Date"/>
                </div>
            </div>

        </div>
        <div className="flex justify-center items-center gap-5 text-lg my-10">
          <p onClick={handleUpload} className='underline text-[#4e9352] font-semibold cursor-pointer'>Upload Customer Invoice</p>
          <div className="">
                <small>
                    ...
                    {!isFileUploaded ? (
                         <label htmlFor="attachment" className='text-blue-500 cursor-pointer'>
                            <FontAwesomeIcon icon={faUpload} className='mr12'/>
