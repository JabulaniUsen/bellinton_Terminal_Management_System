...
const InvoicePrintTemplate = () => {
  ...
  return (
    <div className="">
        {!seeReport ? (<div className='flex items-center flex-col justify-center mt-5'>
        ...
        <div className="flex items-center gap-3">
            ...
            <button className='text-white px-7 py-2 rounded-md bg-blue-700 my-20' onClick={() => {setSeeReport(true)}}>Terminal Invoice Report</button>
        </div>
    </div>) : (
        <TerminalInvoiceReport/>
    )}
    </div>
  )
}
