...
import PaymentConfirmation2 from './PaymentConfirmation2';
                    ...
                    <div className="">
                        <form>
                            ...
                            <div className="buttons flex w-[60%] gap-3 mx-[200px] mt-10">
                                <button className='text-white bg-[#4000FF] rounded-md py-1 px-10' type='button' onClick={handleProceed}>Proceed to Post Payment</button>
