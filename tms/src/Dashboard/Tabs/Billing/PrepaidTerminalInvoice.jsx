...
import TerminalInvoice from './TerminalInvoice';

const PrepaidTerminalInvoice = () => {
    const [showTerminalInvoice, setShowTerminalInvoice] = useState(false) 
    const options2 = [
        ...
        <div className="">
            <form>
                ...
                <div className="buttons flex w-[60%] gap-3 mx-[200px] mt-10">
                    <button className='text-white bg-[#4000FF] rounded-md py-1 px-10' type='submit' onClick={() => setShowTerminalInvoice(true)}>Proceed</button>
...
export default PrepaidTerminalInvoice